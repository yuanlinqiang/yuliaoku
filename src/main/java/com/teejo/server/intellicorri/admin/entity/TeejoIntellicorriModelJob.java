...
@Data
@Document(indexName="job_data",type="job")    //分片修改
public class TeejoIntellicorriModelJob implements Serializable{
    ...
    public TeejoIntellicorriModelJob() {
    }

    public TeejoIntellicorriModelJob(String id, String area, String name, String linename, Integer sn, String datasource, String islabel, String type, Timestamp createtime, Timestamp labeltime, String labeltor, String remark) {
        this.id = id;
        this.area = area;
        this.name = name;
