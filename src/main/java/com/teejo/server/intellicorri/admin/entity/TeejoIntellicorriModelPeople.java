...
@Data
@Document(indexName="people_data",type="people")    //分片修改
public class TeejoIntellicorriModelPeople implements Serializable{
    ...
    public TeejoIntellicorriModelPeople() {
    }

    public TeejoIntellicorriModelPeople(String id, String area, String name, String linename, Integer sn,String datasource,String islabel,String type,Timestamp createtime,Timestamp labeltime,String labeltor,String remark) {
        this.id = id;
        this.area = area;
        this.name = name;
